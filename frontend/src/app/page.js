        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-12 text-center">
              ...
              <div className="p-4 rounded-lg bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
                <div className="text-2xl font-bold text-primary-600 dark:text-primary-400">$2M+</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Total Invested</div>
              </div>
              <div className="p-4 rounded-lg bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm sm:col-span-1 col-span-2">
